        ...
        <main>
            ...
            {listing && !loading && !error && (
                <div>
                    ...
                    <div className='fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h12 flex justify-center items-center bg-slate-100 cursor-pointer'>
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            {
                                listing.offer && (
                                    <p className='bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'>${+listing.regularPrice - listing.discountedPrice} discount</p>
                                )
                            }
                        </div>
